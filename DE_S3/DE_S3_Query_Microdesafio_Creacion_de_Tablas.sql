...
-- CREATE DATABASE DE_S4_DESASTRES;
-- GO
...
-- 5. Crear en la misma base de datos una tabla para alojar resumenes de estadisticas
...
SELECT
	...
	AVG (d.temperatura) AS avg_temp,
FROM desastres d
LEFT JOIN clima c ON d.año = c.año
LEFT JOIN muertes m ON d.año = m.año
GROUP BY 1;
...
SELECT
	...
	AVG (t1.temperatura) AS avg_temp,
	AVG
FROM desastres t1 ,
LEFT JOIN clima c ON t1.año = t2.año
LEFT JOIN muertes m ON t1.año = t2.año
GROUP BY 1;
