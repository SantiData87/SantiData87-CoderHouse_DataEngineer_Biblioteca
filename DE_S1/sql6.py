#Escribir una consulta que devuelva #Para cada agente: el nombre del agente, la cantidad de llamadas, las llamadas más largas y más cortas, 
...
#Consejo: Asegurarse de incluir la cláusula WHERE PickedUp = 1 para calcular solo el promedio de todas las llamadas que fueron atendidas 
#(de lo contrario ¡todas las duraciones mínimas serán 0!)
...
agents_df = pd.read_csv("DE_S1/agents.csv")  # Corregí la variable
