...
--2. Inserción de registros en tabla origencon este código
...
-- 3. Verificar que los registros se hayan insertado
Select * from eventos_apocalipticos

-- 4. Creaicón de tabla de destino
...
-- 5. Query para insertar en tabla destino a partir de tabla origen y agrego dos nueva columnas dias_faltantes y fuente_prediccion
...
-- 6. Verificar si quedaron las inserciones
select * from predicted_end_of_world 

-- 7. Query adicional para responder pregunta de interés
¿Cuál es el número promedio de días restantes hasta los eventos apocalípticos en cada década, y cuántos eventos comienzan con la letra 'D' y la letra 'A' en cada década?
